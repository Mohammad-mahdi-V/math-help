              ...
              >
                ...
                <div className="ai-sets-btn w-full flex-end max-h-[42px] flex mt-4 gap-4 mx-4 ">
                  ...
                  <button
                    ...
                    disabled={aiOutput === 'پاسخی دریافت نشده است' || aiOutput === 'درحال دریافت جواب'|| aiOutput==="اگر از نسخه افلاین استفاده میکنید به دی ان اس متصل شوید اگر در صورتی که از انلاین استفاده میکنید یعنی با محدودیت های نسخه رایگان رو به رو شدیم بعدا تلاش کنید"}
